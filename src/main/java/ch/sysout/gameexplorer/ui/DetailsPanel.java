...
public class DetailsPanel extends JPanel {
	...
	private AbstractButton btnInformations = new JToggleButton(
			"<html><a href='' style='text-decoration: none'>Informations</a>" + "<br>0 messages</html>");
	private AbstractButton btnWarnings = new JToggleButton(
			"<html><a href='' style='text-decoration: none'>Warnings</a>" + "<br>0 messages</html>");
	private AbstractButton btnErrors = new JToggleButton(
			"<html><a href='' style='text-decoration: none'>Errors</a>" + "<br>0 messages</html>");
	...
	private void doHover(AbstractButton btn, boolean b) {
		...
		btn.setText("<html><a href='' style='text-decoration: " + style + "'>" + type + "</a>" + "<br>" + elementCount
				+ " messages</html>");
	}
	...
	private void updateInformationElementsCount() {
		btnInformations.setText("<html><a href='' style='text-decoration: none'>Informations</a>" + "<br>"
				+ pnlInformations.getElementCount() + " messages</html>");

	}

	private void updateWarningElementsCount() {
		btnWarnings.setText("<html><a href='' style='text-decoration: none'>Warnings</a>" + "<br>"
				+ pnlWarnings.getElementCount() + " messages</html>");
	}

	private void incrementErrorElementsCount() {
		btnErrors.setText("<html><a href='' style='text-decoration: none'>Errors</a>" + "<br>"
				+ pnlErrors.getElementCount() + " messages</html>");
	}
