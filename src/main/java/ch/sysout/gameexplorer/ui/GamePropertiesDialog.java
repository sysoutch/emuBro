	...
	private void createMainPanel() {
		FormLayout layout = new FormLayout("default, $lcgap, default, $ugap:grow, $button, min, min",
				"fill:default, fill:default:grow, $ugap, fill:pref, $ugap, fill:pref, $rgap, fill:pref, $ugap, fill:pref, $ugap,"
						+ "fill:pref, $rgap, top:pref, $ugap, fill:pref, $ugap, fill:pref, $rgap, fill:pref, fill:min");
		...
		pnlMain.add(txtGameName = new JTextArea(game.getName()), cc.xywh(3, 1, layout.getColumnCount() - 2, 2));
		...
		pnlMain.add(new JLabel("" + game.getDateAdded()), cc.xyw(3, 18, layout.getColumnCount() - 2));
		pnlMain.add(new JLabel(Messages.get("lastPlayed") + ":"), cc.xy(1, 20));
		pnlMain.add(new JLabel("" + game.getLastPlayed()), cc.xyw(3, 20, layout.getColumnCount() - 2));
	}
