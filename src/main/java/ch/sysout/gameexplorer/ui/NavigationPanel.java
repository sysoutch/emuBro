...
public class NavigationPanel extends JPanel implements ActionListener, MouseListener, GameViewListener {
	...
	private JScrollPane spNavigationButtons = new JScrollPane();
	...
	private int getTotalContentWidth() {
		int sbWidth = (spNavigationButtons.getVerticalScrollBar().isVisible())
				? spNavigationButtons.getVerticalScrollBar().getWidth() : 0;
