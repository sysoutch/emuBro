...
public class ManagePlatformsPanel extends JPanel implements ActionListener {
	...
	class PlatformsPanel extends JPanel implements ActionListener {
		...
		private JButton btnEditPlatform = new JButton(Messages.get("configure"));
		private JCheckBox chkShowOnlyInstalledPlatforms = new JCheckBox(Messages.get("showOnlyInstalledPlatforms"));
		...
		private void createUI() {
			...
			add(btnRemovePlatform, cc.xy(3, 5));
			add(btnEditPlatform, cc.xy(5, 5));
	...
	class EmulatorsPanel extends JPanel implements ListSelectionListener, ActionListener {
		...
		private JButton btnEmulatorProperties = new JButton(Messages.get("configure"));
		private JToggleButton btnEmulatorProperties2 = new JToggleButton(Messages.get("configure"));
