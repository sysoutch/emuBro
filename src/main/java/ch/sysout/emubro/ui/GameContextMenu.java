...
public class GameContextMenu extends JPopupMenu implements GameListener {
	...
	private JMenuItem itmRunWithDefault = new JMenuItem(Messages.get("setEmulator") + "...");
	private JMenuItem itmConfigureEmulator = new JMenuItem(Messages.get("configureEmulator"));
	...
	public GameContextMenu() {
		...
		addComponentsToJComponent(mnuRateGame, pnlRatingBar);
	...
	public void languageChanged() {
		...
		itmRunWithDefault.setText(Messages.get("setEmulator") + "...");
		itmConfigureEmulator.setText(Messages.get("configureEmulator"));
