...
public class AddEmulatorDialog extends JDialog {
	...
	private JExtendedTextField txtName = new JExtendedTextField();
	...
	private void createUI() {
		...
		pnl2.add(new JLinkButton("%emupath%"), cc2.xy(1, 3));
		pnl2.add(new JLabel("- represents the path to the emulator"), cc2.xy(3, 3));

		pnl2.add(new JLinkButton("%gamepath%"), cc2.xy(1, 5));
		pnl2.add(new JLabel("- represents the path to the game"), cc2.xy(3, 5));
	...
	public void setEmulator(BroEmulator emulator) {
		txtName.setText(emulator.getName());
		txtStartParameters.setText(emulator.getStartParameters());
	}
}
