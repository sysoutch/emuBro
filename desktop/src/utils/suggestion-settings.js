...
export function loadSuggestionSettings(storageRef, storageKey = SUGGESTIONS_SETTINGS_KEY) {
...
export function saveSuggestionSettings(settings, storageRef, storageKey = SUGGESTIONS_SETTINGS_KEY) {
  const defaults = getDefaultSuggestionSettings();
