...
public class BlankViewPanel extends ViewPanel {
	...
	public BlankViewPanel() {
		...
		pnlAction.setBorder(new CompoundBorder(BorderFactory.createTitledBorder("Aktion ausführen"), boarder));
		...
		pnlView.setBorder(new CompoundBorder(BorderFactory.createTitledBorder("Ansicht wählen"), boarder));
		...
		pnlHelp.setBorder(new CompoundBorder(BorderFactory.createTitledBorder("Hilfe"), boarder));
