...
public class PreviewPanePanel extends JPanel implements GameSelectionListener {
	...
	class SelectionPanel extends ScrollablePanel {
		...
		protected void setDateAdded(LocalDateTime localDateTime) {
		...
		protected void setLastPlayed(LocalDateTime localDateTime) {
		...
		class LastPlayedPanel extends JPanel {
			...
			public void languageChanged() {
				if (currentGames != null && currentGames.size() == 1) {
					String s = "";
					LocalDateTime lastPlayed = currentGames.get(0).getLastPlayed();
		...
		public void languageChanged() {
			...
			if (currentGames != null) {
				if (currentGames.size() == 1) {
					String formattedDate = "";
					LocalDateTime dateAdded = currentGames.get(0).getDateAdded();
					if (dateAdded != null) {
